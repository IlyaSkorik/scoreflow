...
//
// Резерв = высота глифа + зазор. Зазор (10) ПОКРЫВАЕТ отступ MARK_GAP (8 px),
// на который render.js/print.js поднимают базовую линию символа над нижележащим
// слоём (вольта/темп), плюс небольшой запас. Глиф Segno/Coda рисуется ВВЕРХ от
// базовой линии на ~GLYPH_SIZE, поэтому при зазоре < MARK_GAP верхушка символа
// вылезала бы за зарезервированную полосу (на предыдущую систему/верх страницы).
export function navigationHeadroom(marks) {
    return (marks && marks.length) ? (GLYPH_SIZE + 10) : 0;
}
