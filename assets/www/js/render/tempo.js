...
//
// Резерв — по ФАКТИЧЕСКОМУ верхнему габариту метки: над базовой линией торчит
// штиль (STEM_H, выше текста и головки); + зазор, покрывающий подъём MARK_GAP,
// на который render.js/print.js ставят базовую линию над нижележащим слоем.
export function tempoHeadroom(marks) {
    return (marks && marks.length) ? (STEM_H + 8) : 0;
}
